    ...
    <div className="flex flex-col w-full">
      {results && results.artists.items.length > 0 && (
        <div className="overflow-x-scroll">
          <div
            className={`flex`}
            style={{ width: `${results.artists.items.length * 15}vw` }}
          >
            <div className="w-[15vw] h-[15vw] relative flex justify-center items-center text-4xl font-bold border-b-2 border-[#2b2b2b]">
      ...
      {results && results.albums.items.length > 1 && (
        <div className="overflow-x-scroll">
          <div
            className={`flex`}
            style={{ width: `${results.albums.items.length * 15}vw` }}
          >
            <div className="w-[15vw] h-[15vw] relative flex justify-center items-center text-4xl font-bold border-b-2 border-[#2b2b2b]">
      ...
      {results && results.tracks.items.length > 1 && (
        <div className="overflow-x-scroll">
          <div
            className={`flex`}
            style={{ width: `${results.tracks.items.length * 15}vw` }}
          >
            <div className="w-[15vw] h-[15vw] relative flex justify-center items-center text-4xl font-bold border-b-2 border-[#2b2b2b]">
